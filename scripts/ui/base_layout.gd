...
const STATS_RECT := Rect2(SIDEBAR_INNER_X, 78, SIDEBAR_INNER_WIDTH, 72)
const HP_RECT := Rect2(SIDEBAR_INNER_X, 158, SIDEBAR_INNER_WIDTH, 28)
const MANA_RECT := Rect2(SIDEBAR_INNER_X, 196, SIDEBAR_INNER_WIDTH, 28)
const STATUS_RECT := Rect2(SIDEBAR_INNER_X, 232, SIDEBAR_INNER_WIDTH, 30)
const PROGRESS_RECT := Rect2(SIDEBAR_INNER_X, 268, SIDEBAR_INNER_WIDTH, 54)
const CAMP_UPGRADES_RECT := Rect2(SIDEBAR_INNER_X, 328, SIDEBAR_INNER_WIDTH, 144)
const START_RECT := Rect2(SIDEBAR_INNER_X, 488, SIDEBAR_INNER_WIDTH, 46)
const BUILD_RECT := Rect2(SIDEBAR_INNER_X, 538, SIDEBAR_INNER_WIDTH, 42)
const BUILD_CRUSHER_RECT := Rect2(SIDEBAR_INNER_X, 538, SIDEBAR_INNER_WIDTH, 38)
const BUILD_WHETSTONE_RECT := Rect2(SIDEBAR_INNER_X, 579, SIDEBAR_INNER_WIDTH, 38)
const BUILD_RITUAL_TABLE_RECT := Rect2(SIDEBAR_INNER_X, 620, SIDEBAR_INNER_WIDTH, 38)
const BUILD_CAMPFIRE_RECT := Rect2(SIDEBAR_INNER_X, 661, SIDEBAR_INNER_WIDTH, 38)
...
const CAMP_LAYER_LOCAL_RECTS := {
	...
	"record_player": Rect2(652, 223, 166, 250),
	"storage_chest": Rect2(224, 392, 108, 67),
}
